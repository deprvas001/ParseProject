...
import com.example.parseproject.databinding.ActivityDriverLocationBinding;
...
public class DriverLocationActivity extends FragmentActivity implements View.OnClickListener, OnMapReadyCallback {

    private GoogleMap mMap;
    Intent intent;
    ActivityDriverLocationBinding locationBinding;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
       /* setContentView(R.layout.activity_driver_location);*/
        locationBinding = DataBindingUtil.setContentView(this,R.layout.activity_driver_location);
        locationBinding.acceptRequest.setOnClickListener(this);
        intent = getIntent();
        ...
        locationBinding.relativeLayout.getViewTreeObserver().addOnGlobalLayoutListener(new ViewTreeObserver.OnGlobalLayoutListener() {
            @Override
